...
%if exist (ops.fbinary) == 0 %turn off if you don't need to re-create binary raw data file
    switch ops.datatype 
        case 'openEphys'
        ...
        case 'PLEXON'
        ops = convertPLEXONToRawBinary(ops,do_write); % convert data, only for PLEXON
    end
%end
